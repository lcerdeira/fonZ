...
foz.innerHTML="<a title='ferma la ricerca caratteri' href='javascript:ferma()'>stop</a>"
foz=document.getElementById('nasc');
foz.innerHTML="<a onclick='sulloSfondo()' href='javascript:void(0)' title='esegui sullo sfondo'>nascondi ricerca</a>";
coccio=document.getElementById('stili');
...
info.innerHTML='disponibili&nbsp;<span>'+quanti+'</span><br>attuale';
nasci=document.getElementById('nasc');
nasci.innerHTML='<span>'+quale+'</span>';
}
...
document.write('<ul id="stili"><li class="chiudi" onclick="chiudiStili()"><a href="javascript:void(0)" title="chiudi">&nbsp;X&nbsp;</a></li></ul><br class="clear">');
